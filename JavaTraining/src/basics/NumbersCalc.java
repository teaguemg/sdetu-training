...
public class NumbersCalc {
	...
	//This function has a return type in becasue we are not using static void.  Any method that is not declared void must contain a return statement with a corresponding return value, like this:
//return returnValue;
